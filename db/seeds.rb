...
Bookmark.create(comment: "Such a great director !", movie: Movie.first, list: List.first)
Bookmark.create(comment: "I hated this movie, it was the worst thing I'v ever seen.", movie: Movie.second, list: List.second)
Bookmark.create(comment: "My favourite movie ever !", movie: Movie.third, list: List.first)
Bookmark.create(comment: "What were they thinking while shooting this thing ?!", movie: Movie.fourth, list: List.second)
